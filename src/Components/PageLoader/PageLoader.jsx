...
export default function PageLoader({ children }) {
  ...
  const [glitch, setGlitch] = useState(false); // حالة جديدة للتحكم في مرحلة حركة حرف F
  ...
  useEffect(() => {
    ...
    const startGlitch = setTimeout(() => {
      setGlitch(true);
    }, 1000); // 2. بعد 2.5 ثانية، يبدأ حرف F في الاستقرار في مكانه

    const stabilizeF = setTimeout(() => {
      setF_position("final");
    }, 2500); // 3. يُزال اللودر بعد 4 ثواني
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              perspective: "1000px",
              textShadow:
                "0 0 10px rgba(255, 0, 255, 0.9), 0 0 30px rgba(255, 0, 255, 0.6)",
            }}
            animate={{
